          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <button 
                ...
                className="w-full bg-[#BA9F59] text-[#020617] py-4 font-bold uppercase tracking-widest text-[11px] flex items-center justify-center gap-2 hover:bg-white transition-all shadow-[4px_4px_0_0_rgba(186,159,89,0.2)]"
              >
              ...
              <button 
                ...
                className="w-full text-slate-500 py-3 text-[10px] font-bold uppercase tracking-widest flex items-center justify-center gap-2 hover:text-red-400 transition-colors"
              >
